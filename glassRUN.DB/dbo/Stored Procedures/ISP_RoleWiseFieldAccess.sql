...
-- Created By:   Nimish
-- Procedure to insert entries in the dbo.RoleWiseFieldAccess table
-----------------------------------------------------------------
 
CREATE PROCEDURE [dbo].[ISP_RoleWiseFieldAccess]
@xmlDoc xml 
AS 
 BEGIN 
	SET ARITHABORT ON 
	...
	SET @ErrSeverity = 15; 
        ...
        --Add child table insert procedure when required.
		 ...
		 UPDATE dbo.RoleWiseFieldAccess SET
            ...
            [UpdatedDate] datetime,
            [IPAddress] nvarchar(20)
            )tmp WHERE tmp.RoleWiseFieldAccessId !=0 AND RoleWiseFieldAccess.[RoleWiseFieldAccessId]=tmp.[RoleWiseFieldAccessId]
