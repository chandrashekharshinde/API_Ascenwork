...
Create PROCEDURE [dbo].[SSP_AllObjectProperties] -- '<Json><ServicesAction>LoadAllDeliveryLocation</ServicesAction><ProfileId>390</ProfileId></Json>'
...
SELECT CAST((SELECT  'true' AS [@json:Array] ,
		...
		and Eopm.isactive = 1  group by op.PropertyName
