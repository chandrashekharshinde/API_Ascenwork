CREATE TABLE [dbo].[ReturnPakageMaterial] (
    [ReturnPakageMaterialId] BIGINT          IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_ReturnPakageMaterial] PRIMARY KEY CLUSTERED ([ReturnPakageMaterialId] ASC) WITH (FILLFACTOR = 80)
);
