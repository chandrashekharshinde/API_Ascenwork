CREATE FUNCTION [dbo].[fnPickedForYouItems]
(
	@ReferenceId bigint
)
RETURNS 
...
BEGIN
	...
	where e.SoldTo=@ReferenceId and ep.IsActive=1 and isnull(ep.IsPackingItem,0)=0  and e.CreatedDate>=DATEADD(DAY,-3,GETDATE()) 
