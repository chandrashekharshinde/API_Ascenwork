...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class GlassRUNServiceWebApiManageOrderDTOOrderProductSearchOutputDTO : IEquatable<GlassRUNServiceWebApiManageOrderDTOOrderProductSearchOutputDTO>
    { 
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets VerifiedQuantity
        /// </summary>
        [DataMember(Name="verifiedQuantity")]
        public double? VerifiedQuantity { get; set; }
        ...
        /// <summary>
        /// Gets or Sets ItemPrices
        /// </summary>
        [DataMember(Name="itemPrices")]
        ...
        /// <summary>
        /// Gets or Sets ItemTotalDepositeAmount
        /// </summary>
        [DataMember(Name="itemTotalDepositeAmount")]
        public double? ItemTotalDepositeAmount { get; set; }

        /// <summary>
        /// Gets or Sets ItemTax
        /// </summary>
        [DataMember(Name="itemTax")]
        public long? ItemTax { get; set; }

        /// <summary>
        /// Gets or Sets UsedQuantityInOrder
        /// </summary>
        [DataMember(Name="usedQuantityInOrder")]
        public long? UsedQuantityInOrder { get; set; }

        /// <summary>
        /// Gets or Sets ProductAvailableQuantity
        /// </summary>
        [DataMember(Name="productAvailableQuantity")]
        ...
        /// <summary>
        /// Gets or Sets CheckerDateTime
        /// </summary>
        [DataMember(Name="checkerDateTime")]
        public DateTime? CheckerDateTime { get; set; }

        /// <summary>
        /// Gets or Sets SecurityDateTime
        /// </summary>
        [DataMember(Name="securityDateTime")]
        public DateTime? SecurityDateTime { get; set; }

        /// <summary>
        /// Gets or Sets FinalConfirmDateTime
        /// </summary>
        [DataMember(Name="finalConfirmDateTime")]
        public DateTime? FinalConfirmDateTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlassRUNServiceWebApiManageOrderDTOOrderProductSearchOutputDTO {\n");
            ...
            sb.Append("  VerifiedQuantity: ").Append(VerifiedQuantity).Append("\n");
            ...
            sb.Append("  ItemPrices: ").Append(ItemPrices).Append("\n");
            sb.Append("  DepositeAmountPerUnit: ").Append(DepositeAmountPerUnit).Append("\n");
            sb.Append("  ItemTotalDepositeAmount: ").Append(ItemTotalDepositeAmount).Append("\n");
            sb.Append("  ItemTax: ").Append(ItemTax).Append("\n");
            sb.Append("  UsedQuantityInOrder: ").Append(UsedQuantityInOrder).Append("\n");
            sb.Append("  ProductAvailableQuantity: ").Append(ProductAvailableQuantity).Append("\n");
            ...
            sb.Append("  CheckerDateTime: ").Append(CheckerDateTime).Append("\n");
            sb.Append("  SecurityDateTime: ").Append(SecurityDateTime).Append("\n");
            sb.Append("  FinalConfirmDateTime: ").Append(FinalConfirmDateTime).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GlassRUNServiceWebApiManageOrderDTOOrderProductSearchOutputDTO)obj);
        }

        /// <summary>
        /// Returns true if GlassRUNServiceWebApiManageOrderDTOOrderProductSearchOutputDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of GlassRUNServiceWebApiManageOrderDTOOrderProductSearchOutputDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlassRUNServiceWebApiManageOrderDTOOrderProductSearchOutputDTO other)
        {
            ...
            return 
                ...
                (
                    VerifiedQuantity == other.VerifiedQuantity ||
                    VerifiedQuantity != null &&
                    VerifiedQuantity.Equals(other.VerifiedQuantity)
                ) && 
                (
                ...
                (
                    ...
                    ItemPrices != null &&
                    ItemPrices.Equals(other.ItemPrices)
                ) && 
                (
                ...
                (
                    ItemTotalDepositeAmount == other.ItemTotalDepositeAmount ||
                    ItemTotalDepositeAmount != null &&
                    ItemTotalDepositeAmount.Equals(other.ItemTotalDepositeAmount)
                ) && 
                (
                    ItemTax == other.ItemTax ||
                    ItemTax != null &&
                    ItemTax.Equals(other.ItemTax)
                ) && 
                (
                    UsedQuantityInOrder == other.UsedQuantityInOrder ||
                    UsedQuantityInOrder != null &&
                    UsedQuantityInOrder.Equals(other.UsedQuantityInOrder)
                ) && 
                (
                    ProductAvailableQuantity == other.ProductAvailableQuantity ||
                    ProductAvailableQuantity != null &&
                    ProductAvailableQuantity.Equals(other.ProductAvailableQuantity)
                ) && 
                (
                ...
                (
                    CheckerDateTime == other.CheckerDateTime ||
                    CheckerDateTime != null &&
                    CheckerDateTime.Equals(other.CheckerDateTime)
                ) && 
                (
                    SecurityDateTime == other.SecurityDateTime ||
                    SecurityDateTime != null &&
                    SecurityDateTime.Equals(other.SecurityDateTime)
                ) && 
                (
                    FinalConfirmDateTime == other.FinalConfirmDateTime ||
                    FinalConfirmDateTime != null &&
                    FinalConfirmDateTime.Equals(other.FinalConfirmDateTime)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + VerifiedQuantity.GetHashCode();
                    ...
                    if (ItemPrices != null)
                    hashCode = hashCode * 59 + ItemPrices.GetHashCode();
                    if (DepositeAmountPerUnit != null)
                    hashCode = hashCode * 59 + DepositeAmountPerUnit.GetHashCode();
                    if (ItemTotalDepositeAmount != null)
                    hashCode = hashCode * 59 + ItemTotalDepositeAmount.GetHashCode();
                    if (ItemTax != null)
                    hashCode = hashCode * 59 + ItemTax.GetHashCode();
                    if (UsedQuantityInOrder != null)
                    hashCode = hashCode * 59 + UsedQuantityInOrder.GetHashCode();
                    if (ProductAvailableQuantity != null)
                    hashCode = hashCode * 59 + ProductAvailableQuantity.GetHashCode();
                    if (ImageUrl != null)
                    ...
                    hashCode = hashCode * 59 + CheckerDateTime.GetHashCode();
                    if (SecurityDateTime != null)
                    hashCode = hashCode * 59 + SecurityDateTime.GetHashCode();
                    if (FinalConfirmDateTime != null)
                    hashCode = hashCode * 59 + FinalConfirmDateTime.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(GlassRUNServiceWebApiManageOrderDTOOrderProductSearchOutputDTO left, GlassRUNServiceWebApiManageOrderDTOOrderProductSearchOutputDTO right)
        {
